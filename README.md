...
## Usage
  ...
  - I suggest making a copy of your installation from steamapps/common/Spelunky 2 somewhere else and installing Goldberg steam emulator along with it to be able to run old versions off steam. Grab a copy from https://gitlab.com/Mr_Goldberg/goldberg_emulator/-/releases and follow the instructions for that.
    - TL;DR: Copy the steam_api64.dll from the zip to the game directory and create steam_appid.txt with the text 418530 in it
